...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bannerBtn.setGeometry(QtCore.QRect(40, 270, 121, 41))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(360, 350, 301, 81))
        ...
        self.startTimeLabel.setGeometry(QtCore.QRect(40, 320, 61, 16))
        self.startTimeLabel.setObjectName(_fromUtf8("startTimeLabel"))
        self.startTimeLabel_2 = QtGui.QLabel(self.centralwidget)
        self.startTimeLabel_2.setGeometry(QtCore.QRect(40, 370, 61, 16))
        self.startTimeLabel_2.setObjectName(_fromUtf8("startTimeLabel_2"))
        self.startTimeWidget = QtGui.QTimeEdit(self.centralwidget)
        self.startTimeWidget.setGeometry(QtCore.QRect(40, 340, 121, 21))
        self.startTimeWidget.setObjectName(_fromUtf8("startTimeWidget"))
        self.endTimeWidget = QtGui.QTimeEdit(self.centralwidget)
        self.endTimeWidget.setGeometry(QtCore.QRect(40, 390, 121, 21))
        self.endTimeWidget.setObjectName(_fromUtf8("endTimeWidget"))
        self.publishButton = QtGui.QPushButton(self.centralwidget)
        self.publishButton.setGeometry(QtCore.QRect(40, 440, 121, 41))
